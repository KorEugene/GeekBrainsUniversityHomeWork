...
public class HW1 {
    public static void main(String[] args) {
         ...
         */
        System.out.println("год " + isLeapYear(400)); // каждый 400-ый високосный
        System.out.println("год " + isLeapYear(800)); // каждый 400-ый високосный
        System.out.println("год " + isLeapYear(300)); // каждый 100-ый невисокосный
        System.out.println("год " + isLeapYear(500)); // каждый 100-ый невисокосный
        System.out.println("год " + isLeapYear(1440)); // каждый 4-ый високосный
        System.out.println("год " + isLeapYear(1980)); // каждый 4-ый високосный
        System.out.println("год " + isLeapYear(1111)); // все остальные невисокосные
        System.out.println("год " + isLeapYear(333)); // все остальные невисокосные
    }
    ...
    public static String isLeapYear(int year) {
        return year % 400 == 0 || year % 4 == 0 && year % 100 != 0 ? "високосный!" : "невисокосный!";
    }
}
